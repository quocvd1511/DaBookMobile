...
const Item = ({ name,price,img }) => (
        <View style={styles.item}>
                <View style={{backgroundColor: 'dodgerblue', padding: 25, borderRadius:5}}>
                    <Image style={{height:50, width:50,tintColor: 'white'}} source={{uri:img}}/>
                </View>

                <View style={{marginLeft:10}}>
                    <Text style={{color:'black', fontSize: 12}}>Loại: {name}</Text>
                    <Text style={{color: 'black', fontSize: 12}}>Giảm: {price}</Text>
